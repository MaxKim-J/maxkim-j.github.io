...
이번 포스팅에서는 제가 웹 접근성의 정확한 정의와 함께, 웹 접근성을 준수하면 취할 수 있는 여러 장점들을 **유저 관점**, **개발자 관점**, **서비스 관점**에서 살펴봅니다.
...
![이미지 요소 2](../uploads/web-accessibility-virtuous-cycle/img-vo2.png)
...
웹 접근성의 목표는 "모든 유저"입니다. 웹 접근성은 전맹, 약시 유저 말고도 일시적인 장애로 웹 접근이 불편한 유저, 색약이나 광과민성 발작을 가진 유저, 또는 제한된 하드웨어만으로 웹에 접근해야 하는 환경에서의 웹 접근도 고려합니다. 
...
![chart](../uploads/web-accessibility-virtuous-cycle/chart.gif)
