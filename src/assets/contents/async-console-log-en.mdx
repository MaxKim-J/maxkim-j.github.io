...
According to [this post](https://jakearchibald.com/2015/tasks-microtasks-queues-and-schedules/), task scheduling aims to schedule JavaScript and DOM-related behaviors to be executed sequentially. In contrast, microtask scheduling aims to schedule behaviors so they can be executed **right after** the current behavior. It's a high prioritization.
