...
특정 앱에서 다른 마이크로 앱을 Import할때 만들어지는 참조 관계입니다. A 앱에서 B 앱을 import해서 쓰고 있다면 “A앱은 B앱에 대한 Container References가 존재한다.”고 말할 수 있습니다.
...
의존성 공유 기능에 대해서는 다른 포스팅에서 더 자세히 살펴보겠습니다. 이것도 꽤 복잡하거든요. 여기서는 의존성 공유가 가능하더라-정도만 알고 계시면 됩니다.
